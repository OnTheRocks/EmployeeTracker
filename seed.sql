...
USE tracker_db;
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Nathan", "Huber", 13, null);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Matthew", "Sanders", 1, 1);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("James", "Sullivan", 2, 2);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Zachary ", "Baker", 3, 2);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Jonathan", "Seward", 4, 1);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Brooks", "Wackerman", 5, 4);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Brian", "Hainer", 6, 4);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Brian", "Johnson", 7, 1);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Angus", "Young", 8, 7);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Malcolm", "Young", 9, 7);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Cliff", "Williams", 10, 1);
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Phil", "Rudd", 11, 11);
